...
When upgrading to a new major version of Cashier, it's important that you carefully review [the upgrade guide](https://github.com/presttec/laravel-cashier/blob/master/UPGRADE.md).
...
First, require the Cashier package for Stripe with Composer:
    ...
    composer require presttec/laravel-cashier
